...
export function PremiumHero({ language }: PremiumHeroProps) {
  const content = {
    EN: {
      ...
      subtitle: 'Work remotely. Choose your schedule. Build real financial independence with a premium creator agency.',
    ...
    PT: {
      ...
      subtitle: 'Trabalhe remotamente. Escolha seu horário. Construa verdadeira independência financeira com uma agência premium de criadoras.',
    ...
    RU: {
      ...
      subtitle: 'Работайте удаленно. Выбирайте свой график. Создайте настоящую финансовую независимость с премиум агентством для моделей.',
    ...
    UA: {
      ...
      subtitle: 'Працюйте віддалено. Обирайте свій графік. Побудуйте справжню фінансову незалежність з преміум агентством для моделей.',
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-xl text-gray-700 mb-10 font-medium leading-relaxed max-w-xl">
              {text.subtitle}
            </p>
